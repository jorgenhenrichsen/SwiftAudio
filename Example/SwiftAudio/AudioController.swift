...
class AudioController {
    ...
    let sources: [AudioItem] = [
        DefaultAudioItem(audioUrl: "https://drive.google.com/uc?id=17EBe2XD_XXKH3izZFl1RKd4tA_TZitk5", artist: "Bon Iver", title: "33 \"GOD\"", albumTitle: "22, A Million", sourceType: .stream, artwork: #imageLiteral(resourceName: "22AMI")),
